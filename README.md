...
Cet atelier a pour objectif de vous apprendre à mettre en ligne un CV grace à une application Python et via l'utilisation d'API. Vous allez utiliser et mettre en oeuvre au travers de cet atelier, un serveur Python utilisant le Framework Flask. 
Vous allez créer des API, découvrir les Actions et les Secrets GitHUB pour au final mettre en service un CV en ligne et recueillir les messages de vos visiteurs.
...
2° - Faites un Fork du Repository suivant : https://github.com/OpenRSI/CV_Flask.git  
Voici une vidéo d'accompagnement pour vous aider dans les "Forks" : [Forker ce projet](https://youtu.be/p33-7XQ29zQ)    
  
**Travail demandé :** Créé votre compte GitHUB, faites le fork de ce projet et **copier l'URL de votre Repository GitHUB et transmettez la à votre correcteur**.
...
**Travail demandé :** Mettre en ligne votre application Flask "Hello World !" et **copier l'URL de votre site et transmettez la à votre correcteur**.  
